...
If output is headed to a VGA display with base pointers hbp and vbp along with current coordinates hc and vc, for example, getting the current pixel would look like this:
```Verilog
